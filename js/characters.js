...
const Characters = (() => {
  ...
  const CLASE_SPELLS = {
    ...
    'Hechicero': [
      ...
      { id:'hypnotic-pattern-s',name:'Hypnotic Pattern',  level:3, castTime:'Acción',       range:'36 m',       duration:'1 min',   concentration:true,  combat:true,  desc:'Cubo 9m · save SAB o encantado e incapacitado. Se rompe si ven u oyen algo brusco.' },
