...
const Characters = (() => {
  ...
  const TRASFONDOS_CONFIG = {
    ...
    'Sabio Callejero': {
      ...
      featureDesc: 'Conocés los pasajes secretos y callejones de la ciudad. Puedes moverte entre dos puntos el doble de rápido.',
    },
    'Ermitaño': {
    ...
    'Guía': {
      ...
      feature: 'Wanderer',
      featureDesc: 'Tienes una memoria excelente para mapas y geografía. Siempre puedes recordar el camino de vuelta y encontrás doble comida al buscar en tu terreno natural.',
    },
    'Mercader': {
      ...
      featureDesc: 'Conocés los precios y mercados. Puedes fijar el valor de objetos y encontrás vendedores en cualquier ciudad.',
    },
    'Granjero': {
      ...
      resources: (nivel) => {
        ...
        return [
          { id:'raven-queen-blessing', name:'Blessing of the Raven Queen',
            ...
            desc:`Teletransportás hasta 9 m a un espacio visible. Ganás resistencia a todo daño hasta el inicio de tu siguiente turno. ${prof} usos (Prof Bonus) por Long Rest.`,
  ...
  const CLASE_FEATURES = {
    ...
    'Bárbaro': {
      ...
      features: (nivel) => [
        ...
        ...(nivel >= 11 ? [{ id:'relentless-rage', name:'Relentless Rage', source:'Bárbaro · Nivel 11', type:'active', action:'Ninguna (salva automática)', range:'Personal', recharge:null,
          desc:'Si caes a 0 HP en Rage, haces save CON (CD 10, +5 por cada uso adicional). Si pasás, quedas con 1 HP.', fullDesc:'' }] : []),
    ...
    'Bardo': {
      ...
      features: (nivel) => [
        ...
        ...(nivel >= 2 ? [{ id:'jack-of-all-trades', name:'Jack of All Trades', source:'Bardo · Nivel 2', type:'passive', action:'Pasiva', range:'Personal', recharge:null,
          desc:'Agregás la mitad de tu Prof Bonus a cualquier check de habilidad donde no tienes proficiencia.', fullDesc:'' }] : []),
    ...
    'Druida': {
      ...
      features: (nivel) => [
        { id:'druidic', name:'Druidic', source:'Druida · Nivel 1', type:'passive', action:'Pasiva', range:'Personal', recharge:null,
          desc:'Conocés Druidic, el idioma secreto de los druidas. Puedes dejar mensajes ocultos que solo otros druidas pueden ver.', fullDesc:'' },
    ...
    'Guerrero': {
      ...
      features: (nivel) => [
        ...
        { id:'weapon-mastery', name:'Maestría con Armas',
          source:'Guerrero · Nivel 1', type:'passive', action:'Pasiva', range:'Personal', recharge:null,
          desc:`Puedes usar la propiedad Mastery de ${nivel>=16?6:nivel>=10?5:nivel>=4?4:3} armas distintas. Cambiás las armas elegidas al terminar un descanso largo.`,
    ...
    'Monje': {
      ...
      features: (nivel) => [
        ...
        ...(nivel >= 3 ? [{ id:'deflect-missiles', name:'Deflect Missiles', source:'Monje · Nivel 3', type:'active', action:'Reacción', range:'Personal', recharge:null, desc:'Reducís el daño de proyectil en 1d10+DES+nivel. Si lo reduces a 0 puedes devolverlo (1 Ki).', fullDesc:'' }] : []),
        ...
        ...(nivel >= 7 ? [{ id:'evasion-monk', name:'Evasion', source:'Monje · Nivel 7', type:'passive', action:'Pasiva', range:'Personal', recharge:null, desc:'Cuando un efecto de área pide save DES: si pasás no recibes daño; si fallas, recibes la mitad.', fullDesc:'' }] : []),
        ...
        ...(nivel >= 15 ? [{ id:'timeless-body-monk', name:'Timeless Body', source:'Monje · Nivel 15', type:'passive', action:'Pasiva', range:'Personal', recharge:null, desc:'No envejeces por medios mágicos. No necesitás comida ni agua.', fullDesc:'' }] : []),
    ...
    'Paladín': {
      ...
      features: (nivel) => [
        ...
        { id:'divine-sense', name:'Divine Sense', source:'Paladín · Nivel 1', type:'active', action:'Acción', range:'60 ft', recharge:'long', desc:`Detectás Celestiales, Fiends y Muertos Vivientes a 60 ft (no ocultos). 1+CAR mod usos/Long Rest.`, fullDesc:'' },
    ...
    'Pícaro': {
      ...
      features: (nivel) => [
        ...
        { id:'thieves-cant', name:"Thieves' Cant", source:'Pícaro · Nivel 1', type:'passive', action:'Pasiva', range:'Personal', recharge:null, desc:'Conocés el lenguaje secreto de los ladrones. Puedes ocultar mensajes en conversaciones normales.', fullDesc:'' },
        ...
        ...(nivel >= 7 ? [{ id:'evasion-rogue', name:'Evasion', source:'Pícaro · Nivel 7', type:'passive', action:'Pasiva', range:'Personal', recharge:null, desc:'Saves de DES contra efectos de área: si pasás, no recibes daño; si fallas, solo la mitad.', fullDesc:'' }] : []),
        ...
        ...(nivel >= 11 ? [{ id:'reliable-talent', name:'Reliable Talent', source:'Pícaro · Nivel 11', type:'passive', action:'Pasiva', range:'Personal', recharge:null, desc:'En checks de habilidad donde tienes proficiencia, tratás resultados 1-9 como si fuera 10.', fullDesc:'' }] : []),
        ...
        ...(nivel >= 15 ? [{ id:'slippery-mind', name:'Slippery Mind', source:'Pícaro · Nivel 15', type:'passive', action:'Pasiva', range:'Personal', recharge:null, desc:'Ganás proficiencia en Wisdom saves. Si ya la tienes, ganas proficiencia en Charisma saves.', fullDesc:'' }] : []),
    ...
    'Rune Knight': {
      ...
      features: (nivel) => [
        ...
        ...(nivel >= 7 ? [{ id:'rk-runic-shield', name:'Runic Shield',
          ...
          desc:'Cuando un aliado que puedes ver es golpeado, forzás al atacante a tirar de nuevo.',
      ...
      resources: (nivel, char) => {
        ...
        return [
          { id:'echo-unleash', name:'Unleash Incarnation',
            ...
            fullDesc:`Cuando usas la función de Ataque múltiple, puedes hacer uno de esos ataques desde la posición de tu eco en lugar de la tuya.\n\nPuedes usar esta habilidad un número de veces igual a tu modificador de Constitución (mínimo 1). Recuperas todos los usos después de un descanso largo.\n\nUsos actuales: ${conMod} (CON mod).` },
        ];
      },
      features: (nivel) => {
        ...
        return [
          { id:'ek-manifest-echo', name:'Manifest Echo',
            ...
            recharge:null,
            desc:'Invocás una copia fantasmal de ti mismo en un espacio desocupado a 4,5 m. El Echo tiene 1 HP + tu CA y usa tu tirada de iniciativa. Puedes moverlo 9 m (acción bonus). Puedes atacar desde su posición. Si el Echo es destruido o te apartás más de 9 m de él, desaparece.',
    ...
    'College of Lore': {
      ...
      features: (nivel) => [
        ...
        ...(nivel >= 6 ? [{ id:'lore-additional-magical-secrets', name:'Additional Magical Secrets',
          ...
          desc:'Aprendés 2 conjuros de cualquier clase (no solo bardo). Cuentan como conjuros de bardo para ti.',
    ...
    'Trickery Domain': {
      ...
      features: (nivel) => [
        ...
        { id:'trick-invoke-duplicity', name:'Invoke Duplicity',
          ...
          desc:'Canal: creás un duplicado ilusorio tuyo (concentración 1 min). Puedes moverte a 6 m de él por turno. Ventaja en ataques si el enemigo está adyacente al duplicado.',
        ...
        ...(nivel >= 6 ? [{ id:'trick-cloak-of-shadows', name:'Cloak of Shadows',
          ...
          fullDesc:'A nivel 6, puedes usar tu Channel Divinity para desvanecerte. Como acción, te vuelves invisible hasta el inicio de tu próximo turno. La invisibilidad termina si atacas, lanzas un conjuro o dañás a una criatura.' }] : []),
    ...
    'Knowledge Domain': {
      ...
      features: (nivel) => [
        { id:'know-blessings', name:'Blessings of Knowledge',
          ...
          desc:'Aprendés 2 idiomas y ganas expertise en 2 de estas skills: Arcana, Historia, Naturaleza o Religión.',
        ...
        ...(nivel >= 8 ? [{ id:'know-visions-of-past', name:'Visions of the Past',
          ...
          desc:'Meditás 1 min para ver visiones del pasado reciente de un lugar u objeto que sostienes.',
      ...
      subclassSpells: (nivel) => [
        ...
        ...(nivel >= 7 ? [
          ...
          { id:'freedom-of-movement', name:'Freedom of Movement', level:4, castTime:'1 acción', range:'Toque',
            ...
            desc:'Ignorás terreno difícil mágico/no mágico, no puedes ser paralizado ni restringido por conjuros.', domain:true },
        ] : []),
        // Nv9
        ...(nivel >= 9 ? [
          { id:'commune-with-nature', name:'Commune with Nature', level:5, castTime:'1 minuto', range:'Personal',
            duration:'Instantáneo', concentration:false, combat:false,
            desc:'Ritual: te sintonizás con la tierra en 4.5 km (o 90 m bajo tierra). Obtienes 3 hechos sobre el área.', domain:true },
    ...
    'Circle of Stars': {
      ...
      features: (nivel) => [
        { id:'stars-star-map', name:'Star Map',
          ...
          desc:'Tienes un mapa estelar que funciona como foco druídico. Puedes lanzar Guidance a voluntad y preparás Guiding Bolt gratis. SAB mod veces/Long Rest puedes lanzarlo sin slot.',
        ...
        { id:'stars-starry-form', name:'Starry Form',
          ...
          desc:'Gastás un uso de Wild Shape: te bañás en luz estelar (brillás) y eliges una constelación: Archer (Guiding Bolt bonus), Chalice (curación bonus al lanzar conjuros), Dragon (ventaja en Concentración).',
        ...
        ...(nivel >= 6 ? [{ id:'stars-cosmic-omen', name:'Cosmic Omen',
          ...
          fullDesc:'A nivel 6, puedes auscultar los cielos para presagiar el futuro. Al terminar un Long Rest, tiras 1d6. Si es impar tienes Weal, si es par tienes Woe. Tienes tantos usos como tu modificador de SAB. Weal — como reacción, cuando una criatura a 9 m hace una tirada, le agregás 1d6. Woe — como reacción, cuando una criatura a 9 m hace una tirada, le restás 1d6.' }] : []),
    ...
    'Phantom': {
      ...
      features: (nivel) => [
        ...
        ...(nivel >= 13 ? [{ id:'ph-ghost-walk', name:'Ghost Walk',
          ...
          desc:'1/Long Rest: te vuelves incorpóreo hasta por 10 min. Puedes pasar a través de objetos/criaturas, eres resistente a no-mágicos, ignorás terreno difícil.',
    ...
    'Swashbuckler': {
      ...
      features: (nivel) => [
        ...
        { id:'sw-rakish-audacity', name:'Rakish Audacity',
          source:'Swashbuckler · Nv3', type:'passive', action:'Pasiva', range:'Personal', recharge:null,
          desc:'Puedes hacer Sneak Attack si eres el único enemigo adyacente al objetivo (no necesitás ventaja). Sumás CAR mod a tiradas de iniciativa.',
    ...
    'Way of Shadow': {
      ...
      features: (nivel) => [
        { id:'shadow-arts', name:'Shadow Arts',
          ...
          desc:'Gastás 2 Ki para lanzar Darkness, Darkvision, Pass Without Trace, o Silence sin componentes. Puedes ver en tu propia Darkness.',
          fullDesc:'Al nivel 3 puedes usar tu ki para duplicar los efectos de ciertos conjuros. Como acción puedes gastar 2 puntos de ki para lanzar Darkness, Darkvision, Pass Without Trace o Silence sin necesitar componentes de conjuro. También puedes gastar 1 punto de ki para lanzar Minor Illusion. Cuando lanzas Darkness con esta feature, puedes ver dentro de la oscuridad que creás.' },
    ...
    'Way of the Four Elements': {
      ...
      features: (nivel) => [
        ...
        ...(nivel >= 6 ? [{ id:'4e-extra-discipline', name:'Extra Elemental Discipline (Nv6)',
          ...
          desc:'Aprendés una disciplina elemental adicional. También puedes usar disciplinas de nivel más alto (hasta nv3 de conjuro con 3 Ki).',
        ...
        ...(nivel >= 11 ? [{ id:'4e-extra-discipline-11', name:'Extra Elemental Discipline (Nv11)',
          ...
          desc:'Aprendés una tercera disciplina adicional. Puedes acceder a disciplinas que requieren nivel 11 (conjuros de hasta nv4 con 4 Ki).',
        ...
        ...(nivel >= 17 ? [{ id:'4e-extra-discipline-17', name:'Extra Elemental Discipline (Nv17)',
          ...
          desc:'Aprendés una cuarta disciplina adicional. Puedes acceder a disciplinas que requieren nivel 17 (conjuros de hasta nv5 con 5 Ki).',
    ...
    'Way of the Astral Self': {
      ...
      features: (nivel) => [
        { id:'astral-arms', name:'Arms of the Astral Self',
          ...
          desc:'Convocás brazos astrales que duran 10 min. Puedes usar SAB en ataques desarmados y atacar a distancia (3 m). Los ataques usan el dado Martial Arts.',
        ...
        ...(nivel >= 6 ? [{ id:'astral-visage', name:'Visage of the Astral Self',
          ...
          desc:'Convocás el rostro astral: ventaja en Intimidación/Perspicacia basadas en SAB, visión en oscuridad 24 m, y entiendes todos los idiomas.',
    ...
    'Path of the Zealot': {
      ...
      features: (nivel) => [
        ...
        { id:'zealot-warrior-of-gods', name:'Warrior of the Gods',
          ...
          fullDesc:'Al nivel 3, tu alma está marcada para la batalla eterna. Los hechizos como Raise Dead, Resurrection o True Resurrection no necesitan componentes materiales costosos cuando se usan en ti.' },
    ...
    'Path of Wild Magic': {
      ...
      features: (nivel) => [
        ...
        { id:'wildmagic-wild-surge', name:'Wild Surge',
          ...
          desc:'Cada vez que entrás en Rage, un efecto mágico aleatorio surge de ti (tabla de 8 resultados: escudos de fuerza, teletransporte, daño necrótico, etc.).',
    ...
    'Oath of Vengeance': {
      ...
      features: (nivel) => [
        ...
        ...(nivel >= 7 ? [{ id:'ven-relentless-avenger', name:'Relentless Avenger',
          ...
          desc:'Cuando golpeás con un ataque de oportunidad, puedes mover la mitad de tu velocidad sin provocar ataques de oportunidad.',
    ...
    'Wild Magic': {
      ...
      features: (nivel) => [
        ...
        ...(nivel >= 6 ? [{ id:'wm-bend-luck', name:'Bend Luck',
          ...
          desc:'2 SP: como reacción, sumas o restás 1d4 a la tirada de ataque, check o save de otra criatura.',
    ...
    'Aberrant Mind': {
      ...
      features: (nivel) => [
        ...
        ...(nivel >= 14 ? [{ id:'am-create-thrall', name:'Create Thrall',
          ...
          desc:'Toque en criatura incapacitada: queda bajo tu control telepático. Detectás su ubicación siempre, y puedes comunicarte con ella.',
    ...
    'School of Divination': {
      ...
      features: (nivel) => [
        ...
        { id:'div-portent', name:'Portent',
          ...
          desc:`Al despertar tiras ${nivel >= 14 ? 3 : 2} d20. Puedes reemplazar cualquier tirada con uno de esos resultados (antes de que se tire).`,
    ...
    'The Fiend': {
      ...
      features: (nivel) => [
        { id:'fiend-dark-ones-blessing', name:"Dark One's Blessing",
          ...
          desc:'Cuando matás a un enemigo, ganas CAR mod + nivel de Brujo HP temporales.',
    ...
    'The Great Old One': {
      ...
      features: (nivel) => [
        ...
        ...(nivel >= 6 ? [{ id:'goo-entropic-ward', name:'Entropic Ward',
          ...
          desc:'Imponés desventaja en un ataque contra ti. Si falla, ganas ventaja en tu próximo ataque contra esa criatura.',
  ...
  const BACKGROUND_FEATS_DESC = {
    'Lucky':                     { desc:'Tienes 3 puntos de suerte. Gastás uno para tirar un d20 adicional en cualquier ataque, check o save (antes de saber el resultado) y eliges cuál resultado usar. Los puntos se recuperan en Long Rest.', fullDesc:'' },
    'Magic Initiate (Clérigo)':  { desc:'Aprendés 2 cantrips y 1 hechizo de nivel 1 de la lista de Clérigo. Puedes lanzar el hechizo de nivel 1 una vez por Long Rest sin gastar un slot (o con un slot si tienes).', fullDesc:'' },
    'Magic Initiate (Mago)':     { desc:'Aprendés 2 cantrips y 1 hechizo de nivel 1 de la lista de Mago. Puedes lanzar el hechizo de nivel 1 una vez por Long Rest sin gastar un slot (o con un slot si tienes).', fullDesc:'' },
    'Magic Initiate (Druida)':   { desc:'Aprendés 2 cantrips y 1 hechizo de nivel 1 de la lista de Druida. Puedes lanzar el hechizo de nivel 1 una vez por Long Rest sin gastar un slot (o con un slot si tienes).', fullDesc:'' },
    'Crafter':                   { desc:'Proficiencia con 3 herramientas de artesano a elección. Al comprar equipo no mágico reducís el costo en 20%. También puedes crear objetos durante los descansos.', fullDesc:'' },
    ...
    'Healer':                    { desc:'Usás un Healer\'s Kit para estabilizar a un personaje caído y además restaurarle 1d6+4+nivel HP. Puedes usarlo una vez por criatura entre descansos cortos/largos.', fullDesc:'' },
  };
  ...
  const GENERAL_FEATS = [
    ...
    { id:'feat-great-weapon-master', name:'Great Weapon Master', category:'Combate', prereq:'FUE 13+', desc:'Con arma de dos manos: -5 al golpe para +10 al daño. Si haces un crítico o matás con ella, haces un ataque de Bonus Action.', fullDesc:'' },
    ...
    { id:'feat-dual-wielder',     name:'Dual Wielder',          category:'Combate', prereq:null, desc:'+1 CA con dos armas. Puedes two-weapon fight con armas no ligeras. Desenfundás/enfundás dos armas a la vez.', fullDesc:'' },
    ...
    { id:'feat-metamagic-adept',  name:'Metamagic Adept',       category:'Magia', prereq:'Capacidad de lanzar conjuros', desc:'Aprendés 2 opciones de Metamagic y ganas 2 Sorcery Points para usarlas (se recuperan en Long Rest). (Tasha\'s)', fullDesc:'' },
    ...
    { id:'feat-linguist',         name:'Linguist',              category:'Utilidad', prereq:null, desc:'+1 INT. Aprendés 3 idiomas. Puedes crear cifrados escritos; solo tú y quienes enseñes pueden leerlos (Investigación para romperlo, CD = 8+INT mod+PB).', fullDesc:'' },
    ...
    { id:'feat-prodigy',          name:'Prodigy',               category:'Utilidad', prereq:'Half-human o humano', desc:'Proficiencia en 1 skill, 1 herramienta y 1 idioma. Ganás Expertise en 1 skill de las que ya tienes proficiencia. (Xanathar\'s)', fullDesc:'' },
    ...
    { id:'feat-lucky',            name:'Lucky',                 category:'Utilidad', prereq:null, desc:'3 puntos de suerte (se recuperan en Long Rest). Gastás uno para tirar un d20 adicional en ataque/check/save y eliges cuál resultado usar. También puedes forzar a que el atacante tire de vuelta y te quedas con el resultado más bajo.', fullDesc:'' },
    ...
    { id:'feat-telekinetic',      name:'Telekinetic',           category:'Utilidad', prereq:null, desc:'+1 INT/SAB/CAR. Aprendés Mage Hand (invisible). Bonus Action: empujás/atraes a criatura a 5 ft (STR save CD 8+PB+stat mod). (Tasha\'s)', fullDesc:'' },
