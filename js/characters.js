  ...
  const CLASE_FEATURES = {
    ...
    'Paladín': {
      ...
      features: (nivel) => [
        ...
        ...(nivel >= 6 ? [{ id:'aura-of-protection', name:'Aura of Protection', source:'Paladín · Nivel 6', type:'passive', action:'Pasiva', range:'10 ft', recharge:null, desc:`Tú y aliados a 10 ft suman +${Math.max(1,Math.floor(((0)-10)/2))} (mod CAR) a todos los Saving Throws.`, fullDesc:'' }] : []),
        ...
        ...(nivel >= 14 ? [{ id:'cleansing-touch', name:'Cleansing Touch', source:'Paladín · Nivel 14', type:'active', action:'Acción', range:'Contacto', recharge:'long', desc:`Terminas un conjuro activo en una criatura (con su consentimiento). ${Math.max(1,1)} usos/Long Rest.`, fullDesc:'' }] : []),
