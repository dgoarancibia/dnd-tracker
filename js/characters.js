    ...
    'Guerrero': {
      ...
      features: (nivel) => [
        ...
        { id:'weapon-mastery', name:'Maestría con Armas',
          source:'Guerrero · Nivel 1', type:'passive', action:'Pasiva', range:'Personal', recharge:null,
          desc:`Podés usar la propiedad Mastery de ${nivel>=16?6:nivel>=10?5:nivel>=4?4:3} armas distintas. Cambiás las armas elegidas al terminar un descanso largo.`,
          fullDesc:'Cada arma con propiedad Mastery tiene un efecto especial que podés aplicar a tus ataques con ella (Cleave, Graze, Nick, Push, Sap, Slow, Topple, Vex). Podés usar Mastery en 3 armas al nv1, 4 al nv4, 5 al nv10 y 6 al nv16. Podés cambiar las armas elegidas al terminar un Long Rest.' },
        ...
        ...(nivel >= 5 ? [{
          ...
          desc: 'Cuando usás Second Wind con una acción bonus, podés moverte hasta la mitad de tu velocidad sin provocar ataques de oportunidad.',
          fullDesc: 'A partir del nivel 5, cuando usás tu rasgo Second Wind (Tomar aliento) con una acción adicional, podés moverte hasta la mitad de tu velocidad. Este movimiento no provoca ataques de oportunidad.',
        }] : []),
        ...
        ...(nivel >= 9 ? [{
          ...
          fullDesc: 'A partir del nivel 9, podés volver a tirar una tirada de salvación fallida. Debés usar el nuevo resultado.\n\n1 uso (nv9) · 2 usos (nv13) · 3 usos (nv17). Se recarga con Long Rest.',
        }, {
          id: 'tactical-master', name: 'Maestro Táctico',
          source: 'Guerrero · Nivel 9', type: 'passive', action: 'Pasiva', range: 'Personal', recharge: null,
          desc: 'Cuando atacás con un arma cuya propiedad Mastery conocés, podés reemplazar esa propiedad por Push, Sap o Slow para ese ataque.',
          fullDesc: 'A partir del nivel 9, cuando atacás con un arma cuya propiedad Mastery conocés, podés reemplazar esa propiedad Mastery por una de las siguientes para ese ataque: Push, Sap o Slow.',
        }] : []),
        ...
        ...(nivel >= 13 ? [{
          ...
          desc: 'Cuando fallás un ataque, ganás ventaja en tu próximo ataque contra ese mismo objetivo en el mismo turno.',
          fullDesc: 'A partir del nivel 13, estudiás meticulosamente a tus enemigos durante el combate. Cuando fallás un ataque con un arma o ataque sin arma, ganás ventaja en tu próxima tirada de ataque contra ese mismo objetivo antes del final de tu turno actual.',
        }] : []),
