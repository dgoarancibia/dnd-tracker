...
const Characters = (() => {
  ...
  const LURSEY_SPELLS = [
    ...
    { id:'toll-dead',    name:'Toll the Dead',    level:0, concentration:false, domain:false, mi:false, bonus:false, ritual:false,
      castTime:'Acción', range:'60 ft', duration:'Instantáneo', damage:'1d8 necrótico (2d12 si ya tiene daño)', upcast:null,
      desc:'Acción · 60 ft · save WIS · 1d8 necrótico (2d12 si el objetivo ya tiene daño) · sin slot · sin ataque', tags:[],
    ...
    { id:'sacred-flame', name:'Sacred Flame',     level:0, concentration:false, domain:false, mi:false, bonus:false, ritual:false,
      castTime:'Acción', range:'60 ft', duration:'Instantáneo', damage:'2d8 radiante', upcast:null,
      desc:'Acción · 60 ft · save DEX (ignora cobertura) · 2d8 radiante · ideal vs enemigos que se cubren', tags:[],
      fullDesc:'Llamas divinas caen sobre una criatura a 60 ft. Hace save DEX — ignora completamente cualquier cobertura — o recibe 2d8 radiante. Escala a 2d8 a nivel 5, 3d8 a nivel 11, 4d8 a nivel 17.' },
    ...
    { id:'thaumaturgy',  name:'Thaumaturgy',      level:0, concentration:false, domain:false, mi:false, bonus:false, ritual:false,
      castTime:'Acción', range:'30 ft', duration:'1 minuto', damage:null, upcast:null,
      desc:'Acción · 30 ft · efectos menores (voz, llamas, temblor, ojos) · duración 1 min · puro roleplay', tags:[],
    ...
    { id:'sanctuary',    name:'Sanctuary ◆',      level:1, concentration:false, domain:true,  mi:false, bonus:false, ritual:false,
      castTime:'Acción de bonus', range:'30 ft', duration:'1 minuto', damage:null, upcast:null,
      desc:'Bonus action · 30 ft · 1 min · quien ataque al objetivo debe pasar save WIS o cambiar blanco · SIN concentración · muy eficiente', tags:['dom'],
      fullDesc:'Proteges a una criatura visible a 30 ft. Cualquier criatura que la ataque o le lance un hechizo dañino debe superar save WIS (CD 15) o elegir otro blanco; si no puede, pierde el ataque. Termina si el objetivo ataca o lanza un hechizo perjudicial. Sin concentración.' },
    // ── NVL 1 PREPARADOS ──
    { id:'bless',        name:'Bless',            level:1, concentration:true,  domain:false, mi:false, bonus:false, ritual:false,
      castTime:'Acción', range:'30 ft', duration:'Concentración (1 min)', damage:null, upcast:'Una criatura adicional por nivel de slot sobre 1.',
      desc:'Acción · 30 ft · conc 1 min · hasta 3 criaturas ganan +1d4 a tiradas de ataque y saves · tu buff más poderoso por slot', tags:['conc'],
      fullDesc:'Hasta 3 criaturas a 30 ft añaden 1d4 a todas sus tiradas de ataque y saves mientras dure la concentración. Al upcastear puedes afectar a una criatura adicional por nivel de slot extra.' },
    { id:'heal-word',    name:'Healing Word',     level:1, concentration:false, domain:false, mi:false, bonus:true,  ritual:false,
      castTime:'Acción de bonus', range:'60 ft', duration:'Instantáneo', damage:null, upcast:'1d4 HP adicionales por nivel de slot sobre 1.',
      desc:'Bonus action · 60 ft · 1d4+4 HP · levanta aliados caídos sin gastar la acción principal · imprescindible', tags:['bonus'],
      fullDesc:'Una criatura visible a 60 ft recupera 1d4+4 HP. Acción de bonus — puedes curar y actuar en el mismo turno. Al upcastear: slot 2 = 2d4+4, slot 3 = 3d4+4, etc.' },
    { id:'command',      name:'Command',          level:1, concentration:false, domain:false, mi:false, bonus:false, ritual:false,
      castTime:'Acción', range:'60 ft', duration:'1 turno', damage:null, upcast:'Una criatura adicional por nivel de slot sobre 1.',
      desc:'Acción · 60 ft · save WIS · 1 turno · 1 palabra: Huye / Detente / Cae / Acércate / Suéltalo · upcasteable a más objetivos', tags:[],
      fullDesc:'Das una orden de una palabra a una criatura visible a 60 ft. Save WIS (CD 15) o cumple la orden en su siguiente turno. Opciones: Acércate, Huye (Dash), Cae (al suelo), Detente (no actúa), Suéltalo (suelta lo que sostiene). No funciona en muertos vivientes ni inmunes a encantamientos.' },
    ...
    { id:'detect-magic', name:'Detect Magic',     level:1, concentration:true,  domain:false, mi:false, bonus:false, ritual:true,
      castTime:'Acción (o Ritual +10 min)', range:'Autocentrado (30 ft)', duration:'Concentración (10 min)', damage:null, upcast:null,
      desc:'Acción (ritual) · conc 10 min · 30 ft · detecta magia y su escuela · sin gastar slot como ritual', tags:['conc','ritual'],
      fullDesc:'Percibes la presencia de magia a 30 ft. Puedes usar tu acción para ver el aura de criaturas/objetos mágicos y conocer la escuela de magia. Puede lanzarse como ritual (10 min extra, sin gastar slot).' },
    ...
    { id:'inflict-wounds',name:'Inflict Wounds',  level:1, concentration:false, domain:false, mi:false, bonus:false, ritual:false,
      ...
      desc:'Acción · toque · ataque de conjuro (+7) · 3d10 necrótico · daño enorme pero requiere estar cuerpo a cuerpo', tags:[],
      fullDesc:'Ataque de conjuro cuerpo a cuerpo (+7). Si impactas: 3d10 necrótico. Uno de los daños más altos por slot de nivel 1, pero exige estar a 5 ft. Slot 2 = 4d10, slot 3 = 5d10.' },
    ...
    { id:'shield-faith', name:'Shield of Faith',  level:1, concentration:true,  domain:false, mi:false, bonus:false, ritual:false,
      castTime:'Acción de bonus', range:'60 ft', duration:'Concentración (10 min)', damage:null, upcast:null,
      desc:'Bonus action · 60 ft · conc 10 min · +2 CA · excelente en aliado frente-a-frente o en ti misma', tags:['conc'],
      fullDesc:'Un campo de energía protectora rodea a una criatura a 60 ft, otorgándole +2 CA mientras dure la concentración. Acción de bonus, muy eficiente. Ideal para el aliado de primera línea.' },
    ...
    { id:'guiding-bolt', name:'Guiding Bolt †',   level:1, concentration:false, domain:false, mi:true,  bonus:false, ritual:false,
      castTime:'Acción', range:'120 ft', duration:'1 turno', damage:'4d6 radiante', upcast:'1d6 adicional por nivel de slot sobre 1.',
      desc:'Acción · 120 ft · ataque de conjuro (+7) · 4d6 radiante · el próximo ataque vs ese enemigo tiene ventaja · gratis 1×/día, luego slot 1', tags:['mi'],
    ...
    { id:'aid',          name:'Aid ◆',            level:2, concentration:false, domain:true,  mi:false, bonus:false, ritual:false,
      castTime:'Acción', range:'30 ft', duration:'8 horas', damage:null, upcast:'+5 HP adicionales por nivel de slot sobre 2.',
      desc:'Acción · 30 ft · 8h · hasta 3 criaturas +5 HP máximos y +5 HP actuales · SIN concentración · lanzar al inicio del día', tags:['dom'],
      fullDesc:'Hasta 3 criaturas a 30 ft ganan +5 HP máximos y +5 HP actuales por 8 horas. Sin concentración. Al upcastear: slot 3 = +10, slot 4 = +15, slot 5 = +20. Lanzar al inicio del día junto con slots de dominio.' },
    { id:'warding-bond', name:'Warding Bond ◆',   level:2, concentration:true,  domain:true,  mi:false, bonus:false, ritual:false,
      ...
      fullDesc:'Tocas a otra criatura voluntaria (requiere anillos de plata/hierro para cada uno). El objetivo gana +1 CA, +1 saves, y resistencia a todos los daños. Cada vez que recibe daño, tú también lo recibes. Termina si te alejas más de 60 ft, si cualquiera cae inconsciente, o si pierdes concentración.' },
    // ── NVL 2 PREPARADOS ──
    ...
    { id:'hold-person',  name:'Hold Person',       level:2, concentration:true,  domain:false, mi:false, bonus:false, ritual:false,
      castTime:'Acción', range:'60 ft', duration:'Concentración (1 min)', damage:null, upcast:'Un humanoide adicional por nivel de slot sobre 2.',
      desc:'Acción · 60 ft · conc 1 min · save WIS cada turno · paraliza a 1 humanoide · ataques cuerpo a cuerpo automáticamente crítico · muy poderoso', tags:['conc'],
      fullDesc:'Save WIS (CD 15) o el humanoide queda paralizado. Puede repetir el save al final de cada turno. Paralizado: incapacitado, no puede moverse ni hablar, falla saves STR/DEX, ataques con ventaja, cualquier impacto desde 5 ft es crítico automático. Solo humanoides.' },
    { id:'prayer-healing',name:'Prayer of Healing',level:2, concentration:false, domain:false, mi:false, bonus:false, ritual:false,
      castTime:'10 minutos', range:'30 ft', duration:'Instantáneo', damage:null, upcast:'1d8 adicional por nivel de slot sobre 2.',
      desc:'10 minutos · 30 ft · hasta 6 aliados · 2d8+4 HP cada uno · sin concentración · solo entre combates, mucho tiempo de casteo', tags:[],
      fullDesc:'Hasta 6 criaturas a 30 ft recuperan 2d8+4 HP cada una. El casteo toma 10 minutos — inútil en combate, pero extremadamente eficiente entre encuentros. Sin concentración.' },
    { id:'silence',      name:'Silence',           level:2, concentration:true,  domain:false, mi:false, bonus:false, ritual:true,
      castTime:'Acción (o Ritual +10 min)', range:'120 ft', duration:'Concentración (10 min)', damage:null, upcast:null,
      desc:'Acción (ritual) · 120 ft · conc 10 min · esfera 20 ft · ningún sonido ni conjuro verbal dentro · anula a magos/cléricos enemigos', tags:['conc','ritual'],
      fullDesc:'Esfera de 20 ft de silencio absoluto centrada a 120 ft. Ningún sonido puede crearse ni pasar dentro. Criaturas dentro: inmunes a daño de trueno, no pueden lanzar hechizos con componente verbal. Clave para neutralizar magos y cléricos enemigos.' },
    { id:'spiritual-weapon',name:'Spiritual Weapon',level:2, concentration:false, domain:false, mi:false, bonus:true, ritual:false,
      castTime:'Acción de bonus', range:'60 ft', duration:'1 minuto', damage:'1d8+4 radiante', upcast:'1d8 adicional por 2 niveles de slot sobre 2.',
      desc:'Bonus action · 60 ft · 1 min · arma espectral bonus action cada turno · 1d8+4 radiante · SIN concentración · excelente con Bless activo', tags:['bonus'],
      fullDesc:'Creas un arma espectral a 60 ft. Como acción de bonus cada turno puedes moverla 20 ft y atacar: +7 al ataque, 1d8+4 radiante. Sin concentración — compatible con Bless. Slot 3/4 = 2d8+4, slot 5/6 = 3d8+4.' },
    ...
    { id:'beacon',       name:'Beacon of Hope ◆', level:3, concentration:true,  domain:true,  mi:false, bonus:false, ritual:false,
      castTime:'Acción', range:'30 ft', duration:'Concentración (1 min)', damage:null, upcast:null,
      desc:'Acción · 30 ft · conc 1 min · ventaja en saves WIS y tiradas de muerte · curación siempre al máximo · usar con Warding Bond', tags:['conc','dom'],
      fullDesc:'Cualquier número de criaturas a 30 ft obtienen: ventaja en saves WIS y tiradas de muerte, y toda curación recupera el máximo posible de HP. Con Healing Word o Mass Healing Word, la curación es siempre máxima.' },
    ...
    { id:'spirit-guard', name:'Spirit Guardians', level:3, concentration:true,  domain:false, mi:false, bonus:false, ritual:false,
      castTime:'Acción', range:'Autocentrado (15 ft)', duration:'Concentración (10 min)', damage:'3d8 radiante o frío', upcast:'1d8 adicional por nivel de slot sobre 3.',
      desc:'Acción · auto · conc 10 min · radio 15 ft · 3d8 rad o frío a todo enemigo que entre o empiece turno dentro · velocidad ÷2 · tu hechizo más dañino', tags:['conc'],
      fullDesc:'Espíritus en radio 15 ft. El área es terreno difícil para enemigos. Cuando un enemigo entra o empieza su turno en el área: save WIS (CD 15), fallo = 3d8 radiante o frío, éxito = la mitad. Slot 4 = 4d8, slot 5 = 5d8. Tu hechizo ofensivo más eficiente en combate prolongado.' },
    { id:'mass-heal-w',  name:'Mass Healing Word',level:3, concentration:false, domain:false, mi:false, bonus:true,  ritual:false,
      castTime:'Acción de bonus', range:'60 ft', duration:'Instantáneo', damage:null, upcast:'1d4 adicional por nivel de slot sobre 3.',
      desc:'Bonus action · 60 ft · hasta 6 criaturas · 1d4+4 HP cada una · levanta a todo el grupo · SIN concentración · solo para emergencias masivas', tags:['bonus'],
      fullDesc:'Hasta 6 criaturas a 60 ft recuperan 1d4+4 HP cada una. Acción de bonus, sin concentración — ideal cuando varios aliados caen en el mismo turno.' },
    ...
    { id:'dispel-magic', name:'Dispel Magic',     level:3, concentration:false, domain:false, mi:false, bonus:false, ritual:false,
      castTime:'Acción', range:'120 ft', duration:'Instantáneo', damage:null, upcast:'Con slot igual al nivel del hechizo objetivo, lo termina automáticamente sin check.',
      desc:'Acción · 120 ft · termina automáticamente conjuros nivel 3 o menos · vs nivel 4+ requiere check (CD = 10 + nivel del hechizo) · esencial', tags:[],
      fullDesc:'Elige una criatura, objeto o efecto mágico a 120 ft. Hechizos de nivel 3 o menos terminan automáticamente. Para nivel 4+: check de habilidad con MOD SAB contra CD 10 + nivel del hechizo. Al upcastear con slot del mismo nivel, termina automáticamente.' },
    ...
    { id:'speak-dead',   name:'Speak with Dead',  level:3, concentration:false, domain:false, mi:false, bonus:false, ritual:false,
      castTime:'Acción', range:'10 ft', duration:'10 minutos', damage:null, upcast:null,
      ...
      fullDesc:'Concedes semblanza de vida a un cadáver a 10 ft. Puede responder hasta 5 preguntas sobre lo que sabía en vida. Las respuestas son breves y crípticas. No está obligado a decir la verdad. No funciona si se usó el hechizo en el cadáver en los últimos 10 días.' },
    ...
    { id:'water-walk',   name:'Water Walk',       level:3, concentration:false, domain:false, mi:false, bonus:false, ritual:true,
      castTime:'Acción (o Ritual +10 min)', range:'30 ft', duration:'1 hora', damage:null, upcast:null,
      desc:'Acción (ritual) · 30 ft · 1h · hasta 10 criaturas caminan sobre agua/ácido/lodo/nieve · sin concentración · muy útil en exploración', tags:['ritual'],
      fullDesc:'Hasta 10 criaturas a 30 ft caminan sobre cualquier superficie líquida (agua, ácido, barro, nieve, lava) como si fuera terreno sólido. Sin concentración. Muy útil en exploración. Puede lanzarse como ritual.' },
  ];
  ...
  function buildLursey() {
    ...
    return {
      ...
      magicItems: [],
      consumables: [
        { id:'pocion-cur', name:'Poción de Curación', qty: 2 }
      ],
