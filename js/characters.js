...
const Characters = (() => {
      ...
      resources: (nivel) => {
        ...
        return [
          { id:'raven-queen-blessing', name:'Blessing of the Raven Queen',
            ...
            desc:`Te teletransportas hasta 9 m a un espacio visible. Ganas resistencia a todo daño hasta el inicio de tu siguiente turno. ${prof} ueres (Prof Bonus) por Long Rest.`,
            fullDesc:`Como acción adicional, puedes teletransportarte mágicamente hasta 9 metros a un espacio desocupado que puedas ver.\n\nCuando te teletransportas, ganas resistencia a todo el daño hasta el inicio de tu siguiente turno.\n\nPuedes usar esta habilidad un número de veces igual a tu bonificador de competencia (actualmente ${prof}). Recuperas todos los ueres al terminar un descanso largo.` },
        ];
      },
  ...
  const LURSEY_SPELLS = [
    ...
    { id:'guiding-bolt', name:'Guiding Bolt †',   level:1, concentration:false, domain:false, mi:true,  bonus:false, ritual:false,
      ...
      fullDesc:'Ataque de conjuro a distancia (+7). Si impacta: 4d6 radiante y el objetivo queda iluminado — el primer ataque contra él antes de tu próximo turno tiene ventaja. Gratis 1×/día largo (Magic Initiate); ueres extra consumen slot 1. Slot 2 = 5d6, slot 3 = 6d6.' },
    // ── NVL 2 DOMINIO ──
    ...
    { id:'animate-dead', name:'Animate Dead',     level:3, concentration:false, domain:false, mi:false, bonus:false, ritual:false,
      ...
      fullDesc:'Animas hueeres o un cadáver mediano/pequeño convirtiéndolo en esqueleto o zombi bajo tu control. Obedece órdenes verbales. Puedes controlar hasta 3 creados con este hechizo. Relanzarlo en los últimas 24h renueva el control. Éticamente cuestionable para un Clérigo de Paz.' },
    ...
    'Clérigo': {
      ...
      features: (nivel) => [
        ...
        ...(nivel >= 6 ? [{ id:'channel-divinity-2', name:'Channel Divinity (3 usos)', source:'Clérigo · Nivel 6', type:'passive', action:'Pasiva', range:'Personal', recharge:null,
          desc:'Channel Divinity ahora tiene 3 ueres por Short Rest.', fullDesc:'' }] : []),
    ...
    'Bardo': {
      ...
      features: (nivel) => [
        { id:'bardic-inspiration', name:`Bardic Inspiration (d${nivel>=15?12:nivel>=10?10:nivel>=5?8:6})`, source:'Bardo · Nivel 1', type:'active', action:'Acción bonus', range:'60 ft', recharge: nivel>=5?'short':'long',
          desc:`Das inspiración a un aliado: +d${nivel>=15?12:nivel>=10?10:nivel>=5?8:6} a una tirada en los próximos 10 min. ${nivel>=5?3:1} ueres por ${nivel>=5?'Short':'Long'} Rest.`, fullDesc:'' },
    ...
    'Druida': {
      ...
      features: (nivel) => [
        ...
        ...(nivel >= 2 ? [{ id:'wild-shape', name:`Wild Shape (CR ${nivel>=18?'ilimitado':nivel>=8?1:nivel>=4?'1/2':'1/4'})`, source:'Druida · Nivel 2', type:'active', action:'Acción bonus', range:'Personal', recharge:'short',
          desc:`2 ueres por Short Rest. Tomas la forma de una bestia CR ≤ ${nivel>=18?'cualquiera':nivel>=8?1:nivel>=4?'0.5':'0.25'}.`, fullDesc:'' }] : []),
    ...
    'Explorador': {
      resources: (nivel) => [
        { id:'hunters-mark-uses', name:"Hunter's Mark",
          ...
          recharge:'long',
          note:'Lanzalo sin gastar slot (ueres por Long Rest)' },
      ],
      features: (nivel) => [
        {
          id: 'favored-enemy', name: 'Favored Enemy',
          source: 'Explorador · Nivel 1', type: 'passive', action: 'Pasiva', range: 'Personal', recharge: null,
          desc: 'Hunter\'s Mark no requiere concentración y puedes lanzarlo sin slot (ueres por Long Rest).',
    ...
    'Guerrero': {
      resources: (nivel) => [
        { id:'action-surge', name:'Action Surge',
          ...
          desc:`Tomas una acción adicional completa este turno.${nivel>=17?' 2 ueres por descanso.':' 1 uso por descanso corto/largo.'}`,
          fullDesc:'Puedes tomar una acción adicional en tu turno ademas de tu acción normal y de tu posible acción adicional. Una vez que usas esta habilidad, debes terminar un descanso corto o largo para poder usarla de nuevo (2 ueres desde nivel 17).' },
      ...
      features: (nivel) => [
        ...
        ...(nivel >= 2 ? [{
          ...
          desc: `Tomas una acción adicional completa en tu turno. ${nivel >= 17 ? '2 ueres por descanso.' : '1 uso por descanso corto/largo.'}`,
          fullDesc: 'A partir del nivel 2, puedes tomar una acción adicional en tu turno. 1 uso por Short/Long rest (2 ueres desde nv17).',
        }] : []),
    ...
    'Samurai': {
      ...
      features: (nivel) => [
        ...
        { id:'sam-fighting-spirit', name:'Fighting Spirit',
          ...
          fullDesc:'A partir de nivel 3, la intensidad del combate te potencia. Como acción adicional puedes darte ventaja en todas las tiradas de ataque con arma hasta el final del turno. Cuando haces esto, también ganas puntos de golpe temporales (5 a nivel 3, 10 a nivel 15). Puedes usar esta habilidad tres veces. Recuperas todos los ueres después de un descanso largo.' },
        ...
        ...(nivel >= 10 ? [{ id:'sam-tireless-spirit', name:'Tireless Spirit',
          ...
          desc:'Si tiras iniciativa sin ueres de Fighting Spirit, recuperas 1 uso.',
          fullDesc:'A partir del nivel 10, cuando tiras iniciativa y no te quedan ueres de Fighting Spirit, recuperas 1 uso.' }] : []),
      ...
      features: (nivel) => {
        ...
        return [
          ...
          { id:'ek-unleash-incarnation', name:'Unleash Incarnation',
            ...
            fullDesc:'Cuando usas la función de Ataque múltiple, puedes hacer uno de eeres ataques desde la posición de tu eco en lugar de la tuya. Puedes usar esta habilidad un número de veces igual a tu modificador de Constitución (mínimo 1). Recuperas todos los ueres después de un descanso largo.' },
          ...
          ...(nivel >= 15 ? [{ id:'ek-reclaim-potential', name:'Reclaim Potential',
            ...
            fullDesc:'A nivel 15, has aprendido a absorber la energía de tu eco cuando es destruido. Cuando tu eco es destruido por recibir daño, puedes ganar puntos de golpe temporales iguales a 2d6 + tu modificador de Constitución. Puedes usar esta característica un número de veces igual a tu modificador de Constitución (mínimo 1). Recuperas todos los ueres tras un descanso largo.' }] : []),
    ...
    'Círculo de la Luna': {
      ...
      features: (nivel) => [
        ...
        ...(nivel >= 10 ? [{ id:'moon-elemental-wild-shape', name:'Elemental Wild Shape',
          ...
          desc:'Gasta 2 ueres de Wild Shape para transformarte en un elemental (aire, tierra, fuego, agua).',
          fullDesc:'Puedes gastar dos ueres de Wild Shape al mismo tiempo para transformarte en un elemental de aire, tierra, fuego o agua.' }] : []),
      ...
      subclassSpells: (nivel) => [
        ...
        ...(nivel >= 3 ? [
          { id:'animate-dead', name:'Animate Dead', level:3, castTime:'1 minuto', range:'3 m',
            ...
            desc:'Animas un montón de hueeres o cadáver como zombi o esqueleto bajo tu control (24 hs, renovable).', domain:true },
    ...
    'Circle of Stars': {
      ...
      features: (nivel) => [
        ...
        ...(nivel >= 6 ? [{ id:'stars-cosmic-omen', name:'Cosmic Omen',
          ...
          fullDesc:'A nivel 6, puedes auscultar los cielos para presagiar el futuro. Al terminar un Long Rest, tiras 1d6. Si es impar tienes Weal, si es par tienes Woe. Tienes tantos ueres como tu modificador de SAB. Weal — como reacción, cuando una criatura a 9 m hace una tirada, le agregas 1d6. Woe — como reacción, cuando una criatura a 9 m hace una tirada, le restas 1d6.' }] : []),
    ...
    'Wild Magic': {
      ...
      features: (nivel) => [
        ...
        ...(nivel >= 18 ? [{ id:'wm-spell-bombardment', name:'Spell Bombardment',
          ...
          fullDesc:'A nivel 18 la energía de tus conjuros aumenta. Cuando tiras daño de un conjuro y obtienes el resultado más alto posible en un dado, elige uno de eeres dados, tíralo de nuevo y suma el resultado al daño total del conjuro. Puedes usar esta habilidad una vez por turno.' }] : []),
      ],
    },
    ...
    'Clockwork Soul': {
      ...
      features: (nivel) => [
        ...
        { id:'cs-restore-balance', name:'Restore Balance',
          ...
          fullDesc:'A nivel 1, cuando una criatura que puedes ver a 18m va a tirar con ventaja o desventaja, puedes usar tu reacción para cancelar la ventaja o desventaja. Puedes usar esta característica un número de veces igual a tu modificador de Carisma (mínimo una). Recuperas todos los ueres al final de un descanso largo.' },
    ...
    'School of Divination': {
      ...
      features: (nivel) => [
        ...
        { id:'div-portent', name:'Portent',
          ...
          desc:`Al despertar tiras ${nivel >= 14 ? 3 : 2} d20. Puedes reemplazar cualquier tirada con uno de eeres resultados (antes de que se tire).`,
