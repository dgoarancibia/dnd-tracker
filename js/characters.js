...
const Characters = (() => {
  ...
  const GENERAL_FEATS = [
    ...
    { id:'feat-great-weapon-master', name:'Great Weapon Master', category:'Combate', prereq:'FUE 13+', desc:'Con arma de dos manos: -5 al golpe para +10 al daño. Si haces un crítico o matas con ella, haces un ataque de Bonus Action.', fullDesc:'' },
