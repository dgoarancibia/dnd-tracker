...
const Characters = (() => {
  ...
  const CLASE_SPELLS = {
    ...
    'Clérigo': [
      ...
      { id:'word-of-radiance',  name:'Word of Radiance',   level:0, castTime:'Acción',       range:'1,5 m',     duration:'Inst.',   concentration:false, combat:true,  desc:'Criaturas adyacentes · save CON · 1d6 radiante. Escala nv5/11/17.' },
      ...
      { id:'spare-the-dying',   name:'Spare the Dying',    level:0, castTime:'Acción bonus', range:'18 m',      duration:'Inst.',   concentration:false, combat:true,  desc:'Estabiliza criatura inconsciente a 18 m (PHB 2024: acción bonus, ranged).' },
      { id:'inflict-wounds-c',  name:'Inflict Wounds',     level:0, castTime:'Acción',       range:'Toque',     duration:'Inst.',   concentration:false, combat:true,  desc:'Ataque de toque · 1d10 necrótico. Escala nv5/11/17.' },
      // ── Nivel 1 ───────────────────────────────────────────────────────────
      ...
      { id:'healing-word',      name:'Healing Word',       level:1, castTime:'Acción bonus', range:'18 m',      duration:'Inst.',   concentration:false, combat:true,  desc:'BA · 1d4+SAB HP. Escala +1d4 por slot.' },
      ...
      { id:'divine-favor',      name:'Divine Favor',       level:1, castTime:'Acción bonus', range:'Uno mismo', duration:'1 min',   concentration:true,  combat:true,  desc:'+1d4 daño radiante a cada ataque con arma. Concentración.' },
      { id:'guiding-bolt',      name:'Guiding Bolt',       level:1, castTime:'Acción',       range:'36 m',      duration:'1 ronda', concentration:false, combat:true,  desc:'Ataque de conjuro · 4d6 radiante · siguiente ataque vs esa criatura tiene ventaja. Escala +2d6.' },
      { id:'inflict-wounds',    name:'Inflict Wounds',     level:1, castTime:'Acción',       range:'Toque',     duration:'Inst.',   concentration:false, combat:true,  desc:'Ataque de toque · 3d10 necrótico. Escala +3d10 por slot.' },
      ...
      { id:'command',           name:'Command',            level:1, castTime:'Acción',       range:'18 m',      duration:'1 ronda', concentration:false, combat:true,  desc:'Save SAB · 1 palabra de comando (Huye, Cae, Acércate, Alto, Suelta). Escala +1 criatura.' },
      ...
      { id:'speak-animals',     name:'Speak with Animals', level:1, castTime:'Acción',       range:'Uno mismo', duration:'10 min',  concentration:false, combat:false, ritual:true, desc:'Comunicación con bestias. Ritual.' },
      // ── Nivel 2 ───────────────────────────────────────────────────────────
      ...
      { id:'enhance-ability',   name:'Enhance Ability',    level:2, castTime:'Acción',       range:'Toque',     duration:'1 h',     concentration:true,  combat:false, desc:'Ventaja en checks de uno de los 6 atributos. Escala: +1 criatura por slot.' },
      ...
      { id:'lesser-restoration', name:'Lesser Restoration', level:2, castTime:'Acción',     range:'Toque',     duration:'Inst.',   concentration:false, combat:false, desc:'Elimina 1 condición: cegado, sordo, paralizado o envenenado, o 1 enfermedad.' },
      ...
      { id:'prayer-of-healing', name:'Prayer of Healing',  level:2, castTime:'10 min',       range:'9 m',       duration:'Inst.',   concentration:false, combat:false, desc:'Hasta 6 criaturas recuperan 2d8+SAB HP. Sin combate. Escala +2d8.' },
      ...
      { id:'spiritual-weapon',  name:'Spiritual Weapon',   level:2, castTime:'Acción bonus', range:'18 m',      duration:'1 min',   concentration:false, combat:true,  desc:'Arma flotante: BA cada turno · 1d8+SAB daño · NO concentración. Escala +1d8 cada 2 slots.' },
      { id:'warding-bond',      name:'Warding Bond',       level:2, castTime:'Acción',       range:'Toque',     duration:'1 h',     concentration:false, combat:false, desc:'Aliado: +1 CA y saves, resistencia a daño. Compartes el daño que recibe.' },
      ...
      // ── Nivel 3 ───────────────────────────────────────────────────────────
      { id:'animate-dead',      name:'Animate Dead',       level:3, castTime:'1 min',        range:'3 m',       duration:'24 h',    concentration:false, combat:false, desc:'Anima esqueleto o zombie bajo tu control por 24h. Escala +2 muertos.' },
      { id:'beacon-of-hope',    name:'Beacon of Hope',     level:3, castTime:'Acción',       range:'9 m',       duration:'1 min',   concentration:true,  combat:false, desc:'Hasta 3 criaturas: ventaja en saves de SAB y de muerte, máximo HP al curar.' },
      ...
      { id:'mass-healing-word', name:'Mass Healing Word',  level:3, castTime:'Acción bonus', range:'18 m',      duration:'Inst.',   concentration:false, combat:false, desc:'BA · hasta 6 criaturas recuperan 1d4+SAB HP c/u. Escala +1d4.' },
      ...
      { id:'sending',           name:'Sending',            level:3, castTime:'Acción',       range:'Ilimitado', duration:'1 ronda', concentration:false, combat:false, desc:'Mensaje de 25 palabras a cualquier criatura conocida. Puede responder.' },
      ...
      { id:'spirit-guardians',  name:'Spirit Guardians',   level:3, castTime:'Acción',       range:'Uno mismo', duration:'10 min',  concentration:true,  combat:true,  desc:'Aura 4,5 m · 3d8 radiante o necrótico por turno · save SAB mitad. Escala +1d8.' },
      ...
      { id:'wind-wall-c',       name:'Wind Wall',          level:3, castTime:'Acción',       range:'36 m',      duration:'1 min',   concentration:true,  combat:true,  desc:'Muro de viento 15×1,5 m · impide proyectiles · 3d8 trueno.' },
      // ── Nivel 4 ───────────────────────────────────────────────────────────
      ...
      { id:'holy-weapon',       name:'Holy Weapon',        level:5, castTime:'Acción bonus', range:'Toque',     duration:'1 h',     concentration:true,  combat:true,  desc:'Arma: +2d8 radiante · BA: explosion 4d8 radiante en esfera. Escala daño.' },
  ...
  const GENERAL_FEATS = [
    ...
    { id:'feat-great-weapon-master', name:'Great Weapon Master', category:'Combate', prereq:'FUE 13+', desc:'(2024) Sumas Prof Bonus al daño con armas pesadas. Si sacas 1 o 2 en un dado de daño con arma pesada, vuelves a tirar ese dado. Si reduces a 0 HP a un enemigo, haces un ataque de Bonus Action con arma pesada.', fullDesc:'Great Weapon Master (PHB 2024)\n\nRequisito: FUE 13+\n\nBeneficios:\n• Daño potenciado — Sumas tu Proficiency Bonus al daño con armas pesadas (Heavy).\n• Retiro de 1s y 2s — Cuando sacas 1 o 2 en un dado de daño con un arma pesada, puedes volver a tirar ese dado. Debes usar el nuevo resultado.\n• Bonus Attack — Cuando reduces a 0 HP a una criatura con un arma pesada o haces un crítico con ella, puedes hacer un ataque adicional con arma pesada como Bonus Action en ese turno.\n\nNota: En 2024 ya NO existe el intercambio -5 ataque /+10 daño. Esa regla era de la edición 2014.' },
