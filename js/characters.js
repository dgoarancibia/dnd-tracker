...
const Characters = (() => {
  ...
  const CLASE_SPELLS = {
    ...
    'Explorador': [
      ...
      // ── Nivel 5 ──
      { id:'commune-nature-r', name:'Commune with Nature', level:5, castTime:'1 min',    range:'Uno mismo',  duration:'Inst.',  concentration:false, combat:false, ritual:true, desc:'Obtienes información sobre el terreno en un radio de 5 km. Ritual.' },
      ...
      { id:'steel-wind-strike-r',name:'Steel Wind Strike', level:5, castTime:'Acción',    range:'9 m',        duration:'Inst.',  concentration:false, combat:true,  desc:'5 ataques a distinta criatura (pueden ser todas distintas): 6d10 fuerza c/u · te teletransportas junto a una.' },
